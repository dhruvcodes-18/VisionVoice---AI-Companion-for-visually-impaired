...
import SpeechEmotion from './components/SpeechEmotion/SpeechEmotion';
    ...
    if (window.location.pathname === "/contact") {
      if (
        ...
        if (command.includes("name")) {
          ...
          const email = command.split("number")[1].trim();

          speak({ text: `Filling number field with ${email}` });

          if (!email) {
            toast.dark("No number found!");
            speak({ text: "No number found!" });
            return;
          }
  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <Route path="/speech-emotion" component={SpeechEmotion} />
